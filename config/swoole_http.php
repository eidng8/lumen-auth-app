...
return [
    ...
    */
    'server' => [
        ...
        'options' => [
            'pid_file' => env(
                'SWOOLE_HTTP_PID_FILE',
                base_path('storage/logs/swoole_http.pid')
            ),
            'log_file' => env(
                'SWOOLE_HTTP_LOG_FILE',
                base_path('storage/logs/swoole_http.log')
            ),
    ...
    */
    'providers' => [
        ...
        // Tells swoole to build flash instances these providers on every request.
